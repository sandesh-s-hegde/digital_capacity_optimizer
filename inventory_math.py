...
[Image of Economic Order Quantity model graph]
...
def calculate_horizontal_sharing(
    ...
    dependency_ratio = (overflow_volume / total_demand) if total_demand > 0 else 0.0
...
def calculate_service_implications(
    ...
    if demand_mean > 0:
        service_reliability_score = 100.0 * (1 - (expected_shortage_units / demand_mean))
    else:
...
def calculate_sustainability_impact(
    ...
    return {
        ...
        "is_green_optimized": bool(savings > 0)
    }
