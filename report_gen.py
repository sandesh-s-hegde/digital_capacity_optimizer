...
def generate_pdf(metrics, ai_summary):
    ...
    pdf.multi_cell(0, 5,
                   "Generated by Digital Capacity Optimizer v2.7.0. This report is for internal planning purposes only.")

    # ✅ FIXED: Explicitly convert bytearray to bytes for Streamlit
